...
public final class DiscordWebhook {
    ...
    */
   public static void logPurchase(DonutShop plugin, String webhookUrl, String playerName, String shopDisplayName,
      ...
      String json = buildPurchaseEmbedJson(playerName, shopDisplayName, itemName, amount, priceFormatted);
   ...
   private static String buildPurchaseEmbedJson(String playerName, String shopDisplayName, String itemName,
      ...
      String safeShop = escapeJson(shopDisplayName);
      String isoTimestamp = java.time.OffsetDateTime.now().toString();
